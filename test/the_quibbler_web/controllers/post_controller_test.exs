defmodule TheQuibblerWeb.PostControllerTest do
  use TheQuibblerWeb.ConnCase

  alias TheQuibbler.Blog

  @create_attrs %{content: "some content", content_html: "some content_html", published_at: ~N[2010-04-17 14:00:00], title: "some title"}
